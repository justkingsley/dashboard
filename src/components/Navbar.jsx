...
const Navbar = () => {
  ...
  }, [screenSize]); ///Tracking screen size changes.
  ...
  return (
    <div className='flex justify-between md:mx-6 p-2 relative'>
      ...
      <NavButton title='Notification' customFunc={() => handleClick('notification')} color='blue' dotColor='#03C9D7' icon={<RiNotification3Line/>}/>

      <TooltipComponent content='Profile' position='BottomCenter'>
        <div className='flex items-center gap-2 rounded-lg hover:bg-light-gray p-1' onClick={() => handleClick('userProfile')}>
          <img src={avatar} className='rounded-full h-8 w-8'/>
          <p>
            <span className='text-gray-400 text-14'>
              Hi, 
            </span>{' '}
            <span className='text-gray-600 text-14 font-bold ml-1'>
              Admin
            </span>
          </p>
